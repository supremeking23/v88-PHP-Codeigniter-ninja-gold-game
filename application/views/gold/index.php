...
<body>
    <div class="container">
        <h1>Your Gold: <span><?=($this->session->has_userdata('score') ? $this->session->userdata('score') : 0 )?></span></h1>
        ...
        <div class="activities">
            <?php if($this->session->has_userdata('activities')):?>
                <?php foreach(array_reverse($this->session->userdata('activities')) as $activity): ?>
                    <?= $activity;?>
                <?php endforeach;?>
            <?php endif;?>
